...
import com.ifnoif.gallery3d.common.BitmapCropTask;
import com.ifnoif.gallery3d.common.BitmapUtils;
import com.ifnoif.gallery3d.common.Utils;
import com.ifnoif.launcher.util.Thunk;
import com.ifnoif.photos.BitmapRegionTileSource;
import com.ifnoif.photos.BitmapRegionTileSource.BitmapSource;
...
public class WallpaperPickerActivity extends WallpaperCropActivity {
    ...
    public static final String EXTRA_WALLPAPER_OFFSET = "com.ifnoif.launcher.WALLPAPER_OFFSET";
        ...
        private BitmapCropTask getDefaultWallpaperCropTask(final WallpaperPickerActivity a,
            ...
            return new BitmapCropTask(a, null, null, -1, -1, -1,
                ...
                protected Boolean doInBackground(Integer... params) {
                    ...
                    try {
                        int FLAG_LOCK = 0x00000002;
                        if (whichWallpaper == FLAG_LOCK) {
    ...
    @Thunk static Bitmap createThumbnail(Point size, Context context, Uri uri, byte[] imageBytes,
        ...
        int FLAG_SYSTEM = 0x00000001;
        if (cropTask.cropBitmap(FLAG_SYSTEM)) {
    ...
    public Pair<ApplicationInfo, Integer> getWallpaperArrayResourceId() {
        ...
        // com.ifnoif.launcher; Resources needs the real package name,
        // com.ifnoif.launcher. So we ask Resources for what it thinks the
