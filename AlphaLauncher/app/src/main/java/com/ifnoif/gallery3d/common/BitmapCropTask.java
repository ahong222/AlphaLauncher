 ...
 */
package com.ifnoif.gallery3d.common;
...
import com.ifnoif.launcher.NycWallpaperUtils;
...
public class BitmapCropTask extends AsyncTask<Integer, Void, Boolean> {
    ...
    protected Boolean doInBackground(Integer... params) {
        return cropBitmap(params.length == 0 ? NycWallpaperUtils.FLAG_SYSTEM : params[0]);
    }
